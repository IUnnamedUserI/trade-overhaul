...
public record TradePayload(int syncId, int slot, boolean isBuying, boolean sellWholeStack, boolean buyWholeStack, boolean buyTen) {
	...
	public void write(PacketByteBuf buf) {
		...
		buf.writeBoolean(buyTen);
	}

	public static TradePayload read(PacketByteBuf buf) {
		return new TradePayload(buf.readInt(), buf.readInt(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean());
	}
}
